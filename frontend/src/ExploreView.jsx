            ...
            {trends.length === 0 ? (
              ...
              <div style={{ borderRadius: '12px', border: '1px solid var(--border)', overflowX: 'auto' }}>
                <div style={{ minWidth: '420px' }}>
                  {/* Column headers */}
                  <div style={{ display: 'grid', gridTemplateColumns: 'minmax(160px, 2fr) 90px 70px 100px', padding: '10px 20px', background: 'rgba(255,255,255,0.02)', borderBottom: '1px solid var(--border)' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column' }}>
                    {trends.map((t, i) => (
                      <div key={i}
                        style={{ display: 'grid', gridTemplateColumns: 'minmax(160px, 2fr) 90px 70px 100px', padding: '14px 20px', background: 'var(--surface)', alignItems: 'center', transition: 'background 0.2s', borderBottom: i < trends.length - 1 ? '1px solid var(--border)' : 'none' }}
